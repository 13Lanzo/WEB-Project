...
export default function New() {
    ...
    const nomeProprietario = localStorage.getItem("nomeUtente") || user?.nome || "Super Proprietario";
    ...
    const handlePublish = async (e) => {
        ...
        const payload = {
            ...
            postiLettoTotali: Number(formData.postiLettoTotali),
            postiLettoDisponibili: Number(formData.postilettoDisponibili),
                    ...
                    <div className="form-column">
                        ...
                        <form onSubmit={handlePublish} className="new-form">
                            ...
                            <div className="input-group">
                                ...
                                <textarea name="descrizione" value={formData.descrizione} onChange={handleChange} placeholder="Inserisci una descrizione dettagliata..." className="input-field" rows="4" required></textarea>
                            </div>
